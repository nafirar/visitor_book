            ...
            child: Row(
              ...
              children: [
                Column(
                  ...
                  children: [
                    Text('Data Pengunjung', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                    SizedBox(height: 5,),
                    Text('Pada ${DateFormat.yMMMEd().format(DateTime.now())}', style: TextStyle(
                    ...
                    itemBuilder: (context,index){
                      return Card(
                        child: ListTile(
                          ...
                          trailing: Text('${DateFormat.yMMMEd().format(DateTime.now())}'),
                        ),
                      );
                    },
                  );
